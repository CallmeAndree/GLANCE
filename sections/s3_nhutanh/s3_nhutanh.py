"""Section 3 — Structural signal: local homophily & relative degree.  Owner: Nhựt Anh.

Nguồn trong paper: §4.2, Hình 1, Bảng 2 (tr.4–5), Hình 3 (tr.8)
Nhiệm vụ chi tiết: sections/s3_nhutanh/TASK.md
...
class S3_02_Content(GlanceScene):
    """Scene nội dung. Copy class này ra nhiều scene: S3_03_, S3_04_, ...
