"""Section 5 — Training objective & kết quả thực nghiệm.  Owner: Thiên Lâm.

Nguồn trong paper: §5.2 (tr.6–7), §6 (tr.7–9), Phụ lục C (tr.16–17)
Nhiệm vụ chi tiết: sections/s5_thienlam/TASK.md

Render:  manim -ql sections/s5_thienlam/s5_thienlam.py -a
"""
...
class S5_02_Content(GlanceScene):
    """Scene nội dung. Copy class này ra nhiều scene: S5_03_, S5_04_, ...
