"""Section 0.2 — Preliminaries.  Owner: Trúc Mai.

Nguồn trong paper: §3 (tr.3) + định nghĩa h_v, d̄_v ở §4.2.1 (tr.4)
Nhiệm vụ chi tiết: sections/s0_background/TASK.md

Render:  manim -ql sections/s0_background/s0b_preliminaries.py -a
"""
...
class S0B_01_Title(GlanceScene):
...
class S0B_02_Content(GlanceScene):
    """Scene nội dung. Copy class này ra nhiều scene: S0B_03_, S0B_04_, ...
