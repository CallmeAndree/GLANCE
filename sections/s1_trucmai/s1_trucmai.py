"""Section 1 — Vấn đề cốt lõi của GNN–LLM fusion trên TAG.  Owner: Trúc Mai.

Nguồn trong paper: §1 Introduction (tr.1–2)
Nhiệm vụ chi tiết: sections/s1_trucmai/TASK.md

Render:  manim -ql sections/s1_trucmai/s1_trucmai.py -a
"""
...
class S1_02_Content(GlanceScene):
    """Scene nội dung. Copy class này ra nhiều scene: S1_03_, S1_04_, ...
