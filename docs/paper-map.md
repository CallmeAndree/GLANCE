...
| §5.2 Training objectives | 7 | **5** | Thiên Lâm |
| §6.1 Experimental setup | 8 | **5** | Thiên Lâm |
| §6.2 Kết quả chính + Bảng 3, 4 | 8 | **5** | Thiên Lâm |
| §6.3 Router: learned properties + Hình 3 | 9 | **3** (Hình 3) + **5** (ablation) | Nhựt Anh / Thiên Lâm |
| §6.4 Large-scale + Bảng 5 | 9–10 | **5** | Thiên Lâm |
| §7 Conclusion | 10 | **5** (đóng video) | Thiên Lâm |
| Appendix A Detailed related work | 15 | **0.1** | Hoàng Phan |
| Appendix B Prompting | 15–17 | **4** (Step 2) | Trần Nguyên |
| Appendix C Training & hyperparameters | 17–19 | **5** | Thiên Lâm |
...
Arxiv23 **45.2 ± 0.7**; Pubmed bin 0.00–0.25 đạt **71.5 ± 0.5**.
...
theo cả degree và homophily lên tới **30.1%** (Hình 4, §E.5).

**Scale (Bảng 5, tr.9–10)**: Arxiv-Year overall **49.8 ± 0.1**, OGB-Products **82.3 ± 0.1**,
...
**Sensitivity K (§6.3, tr.9)**: K = 8→12 cho +3.4% ở $h_v$ < 0.25 (Pubmed, Arxiv23),
...
**Siêu tham số (Appendix C.4, tr.18–19)**: freeze GNN + LLM, chỉ train router $\pi$ và
